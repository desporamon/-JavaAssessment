...
public class CourseService
{
    ...
    public void enrollStudent(String courseId, Student student) {
        if (!enrolledStudents.containsKey(courseId)) {
            //if courseId not found in enrolledStudents, create a new item(courseId, new ArrayList) and add student object
            enrolledStudents.put(courseId, new ArrayList<Student>());
        }
        // if courseId already exist in enrolledStudents HashMap, call for the ArrayList using get(courseId) and add student object into ArrayList.
